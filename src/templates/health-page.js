                    ...
                    <table className='table'>
                        <tbody>
                            <tr style={{ width: '100%', height: '100px' }}>
                                <td>
                                    <FaArrowDown size={50} color={cheraYellow} />
                                </td>
                                <td className='is-size-4' style={{ padding: '10px' }}>
                                    <strong>Reduces</strong> unnecessary loss of life
                                </td>
                            </tr>
                            <tr style={{ width: '100%', height: '100px' }}>
                                <td>
                                    <FaShieldAlt size={50} color={cheraYellow} />
                                </td>
                                <td className='is-size-4' style={{ padding: '10px' }}>
                                    <strong>Protects</strong> the health of infants and children
                                </td>
                            </tr>
                            <tr style={{ width: '100%', height: '100px' }}>
                                <td>
                                    <IoIosTrendingUp size={50} color={cheraYellow} />
                                </td>
                                <td className='is-size-4' style={{ padding: '10px' }}>
                                    <strong>Increases</strong> the likelihood that children will
                                    complete their education
                                </td>
                            </tr>
                            <tr style={{ width: '100%', height: '100px' }}>
                                <td>
                                    <FaUsers size={50} color={cheraYellow} />
                                </td>
                                <td className='is-size-4' style={{ padding: '10px' }}>
                                    <strong>Strengthens</strong> the economy of the community
                                </td>
                            </tr>
                            <tr style={{ width: '100%', height: '100px' }}>
                                <td>
                                    <FaUserMd size={50} color={cheraYellow} />
                                </td>
                                <td className='is-size-4' style={{ padding: '10px' }}>
                                    <strong>Reduces</strong> the numbers of orphans, and attendant
                                    risks, including early pregnancy and HIV infection
                                </td>
                            </tr>
                        </tbody>
                    </table>
